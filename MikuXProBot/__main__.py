...
# for test purposes
def error_callback(update: Update, error):
    try:
        raise error
    except Unauthorized:
        print("no nono1")
...
@run_async
def settings_button(update: Update):
    query = update.callback_query
...
@run_async
def get_settings(update: Update):
    chat = update.effective_chat  # type: Optional[Chat]
